    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason', models.CharField(choices=[('spam', 'Spam'), ('duplicate', 'Duplicate'), ('fake', 'Fake/Invalid'), ('inappropriate', 'Inappropriate Content'), ('other', 'Other')], max_length=20)),
                ...
                ('reported_issue', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reports', to='website.issue')),
