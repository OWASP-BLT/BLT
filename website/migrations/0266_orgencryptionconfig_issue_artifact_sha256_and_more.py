# Generated by Django 5.1.8 on 2026-02-17 06:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "preferred_method",
                    models.CharField(
                        choices=[("age", "age (public key)"), ("openpgp", "OpenPGP (GnuPG)")],
                        default="age",
                        max_length=20,
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                ...
                max_length=64,
                validators=[website.models.validate_sha256_if_present],
            ),
        ),
        migrations.AddField(
            model_name="issue",
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True, help_text="Encryption method used (e.g. age, openpgp).", max_length=20),
        ),
        migrations.AddField(
            model_name="issue",
            name="is_zero_trust",
        ...
        migrations.AddIndex(
            model_name="issue",
            index=models.Index(fields=["is_zero_trust"], name="issue_zero_trust_idx"),
        ),
        migrations.AddField(
            model_name="orgencryptionconfig",
            name="organization",
            field=models.OneToOneField(
                on_delete=django.db.models.deletion.CASCADE, related_name="encryption_config", to="website.organization"
            ),
        ),
    ]
