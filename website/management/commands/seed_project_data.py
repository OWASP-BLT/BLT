        ...
        sample_projects = [
            {
                ...
                'status': 'flagship',
                'repos': [
                    {'name': 'zaproxy', 'stars': 12453, 'forks': 2234, 'open_issues': 89, 'commits': 15234, 'contributors': 234},
                ]
            },
            {
                ...
                'status': 'flagship',
                'repos': [
                    {'name': 'juice-shop', 'stars': 9876, 'forks': 7890, 'open_issues': 45, 'commits': 8765, 'contributors': 156},
                ]
            },
            {
                ...
                'status': 'flagship',
                'repos': [
                    {'name': 'ModSecurity', 'stars': 7654, 'forks': 1543, 'open_issues': 123, 'commits': 12345, 'contributors': 98},
                ]
            },
            {
                ...
                'status': 'production',
                'repos': [
                    {'name': 'DependencyCheck', 'stars': 5432, 'forks': 987, 'open_issues': 67, 'commits': 6789, 'contributors': 87},
                ]
            },
            {
                'name': 'OWASP Top 10',
                ...
                'status': 'flagship',
                'repos': [
                    {'name': 'Top10', 'stars': 4321, 'forks': 1234, 'open_issues': 12, 'commits': 543, 'contributors': 45},
                ]
            },
            {
                'name': 'OWASP ASVS',
                ...
                'status': 'flagship',
                'repos': [
                    {'name': 'ASVS', 'stars': 3456, 'forks': 876, 'open_issues': 23, 'commits': 2345, 'contributors': 67},
                ]
            },
            {
                ...
                'status': 'production',
                'repos': [
                    {'name': 'SecurityShepherd', 'stars': 2987, 'forks': 654, 'open_issues': 34, 'commits': 4567, 'contributors': 54},
                ]
            },
            {
                'name': 'OWASP Amass',
                ...
                'status': 'production',
                'repos': [
                    {'name': 'Amass', 'stars': 8765, 'forks': 1432, 'open_issues': 56, 'commits': 3456, 'contributors': 76},
                ]
            },
            {
                ...
                'status': 'production',
                'repos': [
                    {'name': 'CheatSheetSeries', 'stars': 23456, 'forks': 4567, 'open_issues': 78, 'commits': 7890, 'contributors': 234},
                ]
            },
            {
                'name': 'OWASP WebGoat',
                ...
                'status': 'production',
                'repos': [
                    {'name': 'WebGoat', 'stars': 6543, 'forks': 3456, 'open_issues': 45, 'commits': 5678, 'contributors': 123},
                ]
            },
        ]
