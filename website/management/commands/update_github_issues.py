            ...
            with transaction.atomic():
                for pr in all_prs:
                    ...
                    try:
                        ...
                        try:
                            ...
                            contributor, contributor_created = Contributor.objects.get_or_create(
                                ...
                                defaults={
                                    ...
                                    # Start at 0 — we increment ONLY when a new GitHubIssue is created
                                    "contributions": 0,
                                },
                            )

                            if not contributor_created:
                                # Only sync profile fields — do NOT touch contributions
                        ...
                        # ── FIX: only increment contributions for brand-new PRs ──
