...
class LabSeederCommand(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for task_data in self.tasks_data:
            ...
            _, content_created = TaskContent.objects.update_or_create(
                task=task, defaults=content_data
            )
        ...
        self.stdout.write(
            self.style.SUCCESS(f"{self.lab_name} lab setup complete with {lab.total_tasks} tasks")
        )
