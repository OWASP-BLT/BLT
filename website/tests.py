...
class MySeleniumTests(LiveServerTestCase):
    ...
    def test_signup(self):
        ...
        self.assertIn(u'Successfully signed in as bugbugbug', body.text)
    ...
    def test_login(self):
        ...
        body = self.selenium.find_element_by_tag_name('body')
        self.assertIn(u'Successfully signed in as bugbug', body.text)
    ...
    def test_post_bug(self):
        ...
        self.selenium.find_element_by_id("description").send_keys('Description')
        ...
        body = self.selenium.find_element_by_tag_name('body')
        self.assertIn(u'Bug added! +3', body.text)