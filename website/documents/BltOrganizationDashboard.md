### Detailed Description of the "Organization Dashboard" UI Component and the url path is "https://blt.owasp.org/domain/{Organization_name}/" for the OWASP Bug Logging Tool (BLT) Application
