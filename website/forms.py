...
class JobForm(forms.ModelForm):
    ...
    captcha = CaptchaField(
        ...
        widget=forms.TextInput(attrs={
            "class": "w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg focus:ring-2 focus:ring-[#e74c3c]",
