...
- **Slackbot & Slack Integration** → `blt-slack-integration`
  - **Repository**: [BLT-Lettuce](https://github.com/OWASP-BLT/BLT-Lettuce) · [BLT-Sammich](https://github.com/OWASP-BLT/BLT-Sammich)
...
- **BLT Lettuce** → Clarify scope, then separate if it's a distinct tool
  - **Repository**: [BLT-Lettuce](https://github.com/OWASP-BLT/BLT-Lettuce)
...
3. **Slackbot** - Can operate via webhooks/API; minimal core dependencies → [BLT-Lettuce](https://github.com/OWASP-BLT/BLT-Lettuce) · [BLT-Sammich](https://github.com/OWASP-BLT/BLT-Sammich)
...
3. **Security Labs** - Requires isolated infrastructure anyway for security → ⚠️ No repository yet
...
1. **BACON Token Service** - Extract blockchain/wallet logic behind API → [BLT-Rewards](https://github.com/OWASP-BLT/BLT-Rewards)
2. **OSSH Recommendation Engine** - ML/algorithm service with own data pipeline → [BLT-OSSH](https://github.com/OWASP-BLT/BLT-OSSH)
3. **Messaging Service** - Real-time WebSocket service (or adopt external solution) → ⚠️ No repository yet
...
3. **Analytics/Stats** - If data warehouse needs emerge, extract to dedicated service → ⚠️ No repository yet
