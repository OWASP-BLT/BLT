...
GOOGLE_RECAPTCHA_SECRET_KEY = env('GOOGLE_RECAPTCHA_SECRET_KEY', default="5AeVgGwafgaebC3AluQ3i3GgAv7XHA2EhK9sAkgi")
GOOGLE_RECAPTCHA_SITE_KEY = env('GOOGLE_RECAPTCHA_SITE_KEY', default="5AeVgGwafgaebLVlfa_Lc8-rXvp8PJX9ueWYyj7U")
