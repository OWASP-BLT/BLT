...
urlpatterns = [
    ...
    re_path(r"^issue/edit/$", website.views.IssueEdit),
    ...
    re_path(r"^accounts/profile/", website.views.profile),
    re_path(r"^delete_issue/(?P<id>\w+)/$", website.views.delete_issue),
    ...
    re_path(r"^stats/$", StatsDetailView.as_view()),
    ...
    re_path(r"^domain_check/$", website.views.domain_check),
    re_path(r"^api/v1/", include(router.urls)),
    re_path(r"^api/v1/userscore/$", website.views.get_score),
    re_path(r"^authenticate/", CustomObtainAuthToken.as_view()),
    re_path(r"^api/v1/createwallet/$", website.views.create_wallet),
    re_path(r"^api/v1/count/$", website.views.issue_count),
    re_path(
        r"^api/v1/createissues/$",
        csrf_exempt(IssueCreate.as_view()),
        name="issuecreate",
    ),
    re_path(r"^api/v1/search/$", csrf_exempt(website.views.search_issues)),
    re_path(
        r"^api/v1/delete_issue/(?P<id>\w+)/$", csrf_exempt(website.views.delete_issue)
    ),
    re_path(r"^api/v1/issue/update/$", csrf_exempt(website.views.UpdateIssue)),
    re_path(r"^api/v1/scoreboard/$", website.views.get_scoreboard),
    re_path(
        r"^api/v1/terms/$",
