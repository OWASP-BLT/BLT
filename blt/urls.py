...
urlpatterns = [
    ...
    path("bug-review-queue/", bug_review_queue, name="bug_review_queue"),
    path("approve-bug/<int:issue_id>/", approve_bug, name="approve_bug"),
    path("reject-bug/<int:issue_id>/", reject_bug, name="reject_bug"),
    re_path(
