...
urlpatterns = [
    ...
    path("github-login/", TemplateView.as_view(template_name="github_login.html"), name="github_login_page"),
    path("accounts/github/login/callback/", github_callback, name="github_callback"),
    path("accounts/github/connect/", GithubConnect.as_view(), name="github_connect"),
    ...
    path("hunt/<int:pk>", ShowBugBountyView.as_view(), name="show_bughunt"),
    re_path(
    ...
    re_path(r"^api/v2/hunts/$", BugBountyApiViewsetV2.as_view(), name="hunts_detail_v2"),
