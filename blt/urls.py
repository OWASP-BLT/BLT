...
from website.api.views import (
    ActivityLogViewSet,
    AuthApiViewset,
    Bug BountyApiViewset,
    Bug BountyApiViewsetV2,
    DomainViewSet,
    FlagIssueApiView,
...
from website.views.company import (
    ...
    OrganizationDashboardManageBug BountyView,
...
urlpatterns = [
    ...
    path("hunt/<int:pk>", ShowBug BountyView.as_view(), name="show_Bug Bounty"),
    re_path(
    ...
    re_path(r"^api/v1/hunt/$", Bug BountyApiViewset.as_view(), name="hunt_details"),
    re_path(r"^api/v2/hunts/$", Bug BountyApiViewsetV2.as_view(), name="hunts_detail_v2"),
    ...
    path(
        "organization/<int:id>/dashboard/Bug Bountys/",
        OrganizationDashboardManageBug BountyView.as_view(),
        name="organization_manage_Bug Bountys",
    ),
    path(
        "organization/dashboard/end_Bug Bounty/<int:pk>",
        EndBug BountyView.as_view(),
        name="end_Bug Bounty",
    ),
    path(
        "organization/<int:id>/dashboard/add_Bug Bounty/",
        AddHuntView.as_view(),
        name="add_Bug Bounty",
    ),
    path(
