...
from website.views.company import (
    ...
    OrganizationDashboardManageBugBountyView,
...
urlpatterns = [
    ...
    path("accounts/github/login/callback/",
         github_callback, name="github_callback"),
    re_path(r"^auth/github/connect/$",
            GithubConnect.as_view(), name="github_connect"),
    ...
    path("accounts/facebook/login/callback/",
         facebook_callback, name="facebook_callback"),
    re_path(r"^auth/facebook/connect/$",
            FacebookConnect.as_view(), name="facebook_connect"),
    re_path(r"^auth/google/connect/$",
    ...
    path("hunt/<int:pk>", ShowBugBountyView.as_view(), name="show_BugBounty"),
    re_path(
    ...
    re_path(r"^dashboard/organization/domains$",
            DomainList.as_view(), name="domain_list"),
    re_path(
    ...
    path("domain/<int:pk>/subscribe/",
         subscribe_to_domains, name="subscribe_to_domains"),
    ...
    # delete comment
    path("content/comment/delete/", delete_content_comment,
         name="delete_content_comment"),
    ...
    re_path(r"^label_activity/$", SpecificIssuesView.as_view(),
            name="all_activitys"),
    re_path(r"^leaderboard/$", GlobalLeaderboardView.as_view(),
    ...
    re_path(r"^api/v1/leaderboard/$",
            LeaderboardApiViewSet.as_view(), name="leaderboard"),
    re_path(
    ...
    path("delete_issue/<str:id>/",
         ensure_csrf_cookie(delete_issue), name="delete_issue"),
    re_path(
    ...
    re_path(r"^invite/$",
            InviteCreate.as_view(template_name="invite.html"), name="invite"),
    ...
    path("education/instructor_dashboard/",
         instructor_dashboard, name="instructor_dashboard"),
    path("education/create-standalone-lecture/",
         create_standalone_lecture, name="create_standalone_lecture"),
    path("education/edit-standalone-lecture/<int:lecture_id>",
         edit_standalone_lecture, name="edit_standalone_lecture"),
    path("education/instructor_dashboard/edit-course/<int:course_id>/",
    ...
    path("education/view-course/<int:course_id>/",
         view_course, name="view_course"),
    path("education/view-lecture/<int:lecture_id>/",
         view_lecture, name="view_lecture"),
    path("education/enroll/<int:course_id>/", enroll, name="enroll"),
    path("education/study_course/<int:course_id>/",
         study_course, name="study_course"),
    path("education/mark-lecture-complete/",
         mark_lecture_complete, name="mark_lecture_complete"),
    path("education/get-course-content/<int:course_id>/",
         get_course_content, name="get_course_content"),
    path(
        "education/course-content-management/<int:course_id>/",
        course_content_management,
        name="course_content_management",
    ),
    path("education/instructor_dashboard/courses/<int:course_id>/sections/add/",
         add_section, name="add_section"),
    path("education/instructor_dashboard/sections/<int:section_id>/edit/",
         edit_section, name="edit_section"),
    path("education/instructor_dashboard/sections/<int:section_id>/delete/",
         delete_section, name="delete_section"),
    # Lecture management
    path("education/instructor_dashboard/sections/<int:section_id>/lectures/add/",
         add_lecture, name="add_lecture"),
    path("education/instructor_dashboard/lectures/<int:lecture_id>/edit/",
         edit_lecture, name="edit_lecture"),
    path("education/instructor_dashboard/lectures/<int:lecture_id>/delete/",
         delete_lecture, name="delete_lecture"),
    # API endpoints
    path("education/instructor_dashboard/api/lectures/<int:lecture_id>/",
         get_lecture_data, name="get_lecture_data"),
    path("education/instructor_dashboard/api/sections/<int:section_id>/",
         get_section_data, name="get_section_data"),
    path(
    ...
    re_path(r"^status/run-command/$", run_management_command,
            name="run_management_command"),
    re_path(r"^status/commands/$", management_commands,
            name="management_commands"),
    path(r"website_stats/", website_stats, name="website_stats"),
    re_path(r"^issue/comment/add/$",
            comments.views.add_comment, name="add_comment"),
    re_path(r"^issue/comment/delete/$",
            comments.views.delete_comment, name="delete_comment"),
    re_path(r"^comment/autocomplete/$",
    ...
    re_path(r"^social/$",
            TemplateView.as_view(template_name="social.html"), name="social"),
    ...
    re_path(r"^api/v1/urlcheck/$",
            UrlCheckApiViewset.as_view(), name="url_check"),
    re_path(r"^api/v1/hunt/$", BugBountyApiViewset.as_view(), name="hunt_details"),
    re_path(r"^api/v2/hunts/$", BugBountyApiViewsetV2.as_view(),
            name="hunts_detail_v2"),
    ...
    path("projects/<slug:slug>/badge/",
         ProjectBadgeView.as_view(), name="project-badge"),
    ...
    path("repository/<int:repo_id>/refresh/",
         refresh_repo_data, name="refresh_repo_data"),
    re_path(r"^report-ip/$", ReportIpView.as_view(), name="report_ip"),
    re_path(r"^reported-ips/$", ReportedIpListView.as_view(),
            name="reported_ips_list"),
    ...
    path(
        "organization/<int:id>/dashboard/BugBounties/",
        OrganizationDashboardManageBugBountyView.as_view(),
        name="organization_manage_BugBounties",
    ),
    path(
        "organization/dashboard/end_BugBounty/<int:pk>",
        EndBugBountyView.as_view(),
        name="end_BugBounty",
    ),
    path(
    ...
    path("discussion-rooms/join-room/<int:room_id>/",
         join_room, name="join_room"),
    path("discussion-rooms/delete-room/<int:room_id>/",
    ...
    path("pending-transactions/", pending_transactions_view,
    ...
    path("get-recommended-repos/", get_recommended_repos,
         name="get_recommended_repos"),
    path("get-recommended-communities/", get_recommended_communities,
    ...
    path("get-recommended-articles/", get_recommended_articles,
         name="get_recommended_articles"),
    path("stats-dashboard/", stats_dashboard, name="stats_dashboard"),
    path("stats/sync-github-projects/",
         sync_github_projects, name="sync_github_projects"),
    path("stats/run-command/", run_management_command,
         name="run_management_command"),
    ...
    path("check_owasp_compliance/", check_owasp_compliance,
         name="check_owasp_compliance"),
    path("create-github-issue/", GithubIssueView.as_view(),
         name="create_github_issue"),
    ...
    path("organization/<slug:slug>/",
         OrganizationDetailView.as_view(), name="organization_detail"),
    path("organization/<slug:slug>/update-repos/",
         update_organization_repos, name="update_organization_repos"),
    # GitHub Issues
    path("github-issues/<int:pk>/", GitHubIssueDetailView.as_view(),
    ...
    path("update-submission-status/<int:submission_id>/",
         update_submission_status, name="update_submission_status"),
    path("initiate-transaction/", initiate_transaction,
         name="initiate_transaction"),
    path("api/get-wallet-balance/", get_wallet_balance, name="get_wallet_balance"),
    path("extension/", TemplateView.as_view(template_name="extension.html"),
         name="extension"),
    ...
    path(
        ...
        include(
            [
                ...
                path("create/", HackathonCreateView.as_view(),
                     name="hackathon_create"),
                path("<slug:slug>/", HackathonDetailView.as_view(),
                     name="hackathon_detail"),
                path("<slug:slug>/edit/", HackathonUpdateView.as_view(),
                     name="hackathon_update"),
                path("<slug:slug>/add-sponsor/", HackathonSponsorCreateView.as_view(),
                     name="hackathon_sponsor_create"),
                path("<slug:slug>/add-prize/", HackathonPrizeCreateView.as_view(),
                     name="hackathon_prize_create"),
    ...
    path("queue/<int:queue_id>/update-txid/",
         update_txid, name="queue_update_txid"),
    ...
    path("api/room-messages/<int:room_id>/",
         room_messages_api, name="room_messages_api"),
    # direct messaging
    path("messaging/", messaging_home, name="messaging"),
    path("messaging/start-thread/<int:user_id>/",
         start_thread, name="start_thread"),
    path("api/messaging/<int:thread_id>/messages/",
         view_thread, name="thread_messages"),
    path("api/messaging/set-public-key/",
         set_public_key, name="set_public_key"),
    path("api/messaging/<int:thread_id>/get-public-key/",
         get_public_key, name="get_public_key"),
]
