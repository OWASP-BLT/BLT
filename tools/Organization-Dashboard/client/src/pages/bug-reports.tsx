...
export default function BugReports() {
  ...
  const handleImportComplete = () => {
    // Refresh the bugs data after import
  ...
  return (
    <div className="container px-4 py-6 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-gray-500">Track and manage bug reports across projects</p>
        </div>
              ...
              <TableBody>
                ...
                {!isLoading && !error && paginatedBugs.map((bug) => (
                  <TableRow key={bug.id} className="hover:bg-gray-50">
                    <TableCell className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">{bug.bugId}</div>
                    </TableCell>
                    <TableCell className="px-6 py-4">
